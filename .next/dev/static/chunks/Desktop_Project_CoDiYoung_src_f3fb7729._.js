...
"[project]/Desktop/Project/CoDiYoung/src/hooks/useAvatarGeneration.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
;
const useAvatarGeneration = (rows, options)=>{
    _s();
    const getAvatar = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useAvatarGeneration.useCallback[getAvatar]": (category, index)=>{
            return `https://api.dicebear.com/9.x/avataaars/svg?seed=${category}-${index}`;
        }
    }["useAvatarGeneration.useCallback[getAvatar]"], []);
    return {
        getAvatar,
        isLoading: false
    };
};
_s(useAvatarGeneration, "FNYpuj2g4aSqtIzmSwl/s6n6n50=");
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Project/CoDiYoung/node_modules/next/dist/compiled/react/jsx-dev-runtime.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$constants$2f$colors$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Project/CoDiYoung/src/constants/colors.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$hooks$2f$useAvatarGeneration$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Project/CoDiYoung/src/hooks/useAvatarGeneration.js [app-client] (ecmascript)");
...
function StudyCategoryApi() {
    ...
    // 커스텀 훅을 사용한 아바타 생성
    const { getAvatar, isLoading: avatarLoading, error: avatarError } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$hooks$2f$useAvatarGeneration$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAvatarGeneration"])(validRows, {
        size: 96
    });
    // 네비게이션 훅
...
_s(StudyCategoryApi, "IjfkWHrM1k2txOSRkbiQdfewynQ=", false, function() {
    return [
        ...
        __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$hooks$2f$useAvatarGeneration$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAvatarGeneration"],
...
"[project]/Desktop/Project/CoDiYoung/src/mock/studyMembers.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";

__turbopack_context__.s([
    "MOCK_GROUPED_STUDIES",
    ()=>MOCK_GROUPED_STUDIES,
    "STUDY_MEMBERS",
    ()=>STUDY_MEMBERS
]);
const STUDY_MEMBERS = [
    {
        ...
        category: "코딩",
        nickname: "코딩왕",
        introduction: "프론트엔드 개발자입니다. 열심히 하겠습니다!"
    },
    {
        id: 2,
        category: "디자인",
    ...
    },
    {
        ...
        category: "영상편집",
        nickname: "편집마스터",
        introduction: "프리미어 프로, 애프터 이펙트 능숙합니다."
    },
    {
        id: 4,
        category: "코딩",
        nickname: "백엔드러버",
        introduction: "Java Spring Boot 주력입니다."
    },
    {
        id: 5,
        category: "디자인",
...
const MOCK_GROUPED_STUDIES = {
    ...
    video: {
        content: STUDY_MEMBERS.filter((m)=>m.category === "영상편집").map((m)=>({
                userId: m.id,
                userImage: null,
                ...m
            }))
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$hooks$2f$useAuth$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Project/CoDiYoung/src/hooks/useAuth.js [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$feature$2f$MainHome$2f$components$2f$CategoryCard$2e$jsx__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Project/CoDiYoung/src/feature/MainHome/components/CategoryCard.jsx [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$studyMembers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Project/CoDiYoung/src/mock/studyMembers.js [app-client] (ecmascript)");
;
var _s = __turbopack_context__.k.signature();
;
;
...
function StudyCategoryMock() {
    ...
    const rows = [
        {
            label: "코딩",
            count: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$studyMembers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_GROUPED_STUDIES"].coding.content.length,
            users: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$studyMembers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_GROUPED_STUDIES"].coding.content
        },
        {
            label: "디자인",
            count: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$studyMembers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_GROUPED_STUDIES"].design.content.length,
            users: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$studyMembers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_GROUPED_STUDIES"].design.content
        },
        {
            label: "영상편집",
            count: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$studyMembers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_GROUPED_STUDIES"].video.content.length,
            users: __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$studyMembers$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_GROUPED_STUDIES"].video.content
        }
    ];
    // 아바타 생성을 위한 유효한 rows만 필터링 (count > 0인 것만)
    const validRows = rows.filter((row)=>row.count > 0);
    // 커스텀 훅을 사용한 아바타 생성
    const { getAvatar, isLoading: avatarLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$hooks$2f$useAvatarGeneration$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAvatarGeneration"])(validRows, {
        size: 96
    });
    // 네비게이션 훅
    const { handleCategoryClick, handleWriteClick } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$feature$2f$MainHome$2f$hooks$2f$useStudyNavigation$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useStudyNavigation"])();
...
function ProjectSectionMock() {
    ...
    const totalProjectsRaw = Array(9 * 44).fill(null).map((_, i)=>{
        const original = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$projects$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_PROJECTS"][i % __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$projects$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_PROJECTS"].length];
        // 태그 다양화 (필터링 테스트용)
        let tags = [
            ...original.tags
        ];
...
"[project]/Desktop/Project/CoDiYoung/src/mock/home.js [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const MOCK_BANNERS = [
    {
        id: 1,
        imageUrl: "https://placehold.co/1200x400/purple/white?text=Banner+1",
        link: "#"
    },
    {
        id: 2,
        imageUrl: "https://placehold.co/1200x400/blue/white?text=Banner+2",
        link: "#"
    }
];
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
...
var __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$home$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/Desktop/Project/CoDiYoung/src/mock/home.js [app-client] (ecmascript)");
;
;
;
function Partners() {
    const partners = __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$src$2f$mock$2f$home$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["MOCK_PARTNERS"];
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
...
//# sourceMappingURL=Desktop_Project_CoDiYoung_src_f3fb7729._.js.map