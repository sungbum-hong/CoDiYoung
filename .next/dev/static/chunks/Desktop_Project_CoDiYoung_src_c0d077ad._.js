...
(()=>{
    const e = new Error("Cannot find module '../../../services/study/StudyService.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../../../services/project/ProjectService.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
(()=>{
    const e = new Error("Cannot find module '../../../services/homeService.js'");
    e.code = 'MODULE_NOT_FOUND';
    throw e;
})();
...
const useMainHomeStudies = (params = {})=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useMainHomeStudies.useQuery": ()=>StudyService.getGroupedStudies(queryParams)
...
const useMainHomeProjects = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useMainHomeProjects.useQuery": ()=>ProjectService.getAllProjects()
        }["useMainHomeProjects.useQuery"],
        staleTime: 10 * 60 * 1000,
        select: {
            "useMainHomeProjects.useQuery": (data)=>{
                // 프로젝트 데이터 가공
...
const useMainHomeBanners = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useMainHomeBanners.useQuery": ()=>HomeService.getBanners()
...
const useMainHomePartners = ()=>{
    ...
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$Desktop$2f$Project$2f$CoDiYoung$2f$node_modules$2f40$tanstack$2f$react$2d$query$2f$build$2f$modern$2f$useQuery$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useQuery"])({
        ...
        queryFn: {
            "useMainHomePartners.useQuery": ()=>HomeService.getPartners()
...
//# sourceMappingURL=Desktop_Project_CoDiYoung_src_c0d077ad._.js.map