  ...
  <div className="grid grid-cols-3 gap-8 text-center text-xs sm:text-sm">
    ...
    <div className="flex flex-col items-center gap-5 leading-normal">
      ...
      <div className="flex justify-center">
        {/* 아이콘 */}
        <svg className="w-6 h-6 block" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
    ...
    <div className="flex flex-col items-center gap-5 leading-normal">
      ...
      <div className="flex justify-center gap-3">
        <svg className="w-5 h-5 block" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round">
