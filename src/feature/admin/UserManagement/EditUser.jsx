...
export default function EditUser({ setIsOpenEditUser, selectedUser }) {
  ...
  const [formData, setFormData] = useState({
    ...
    userCategory: userToEdit.userCategory,
    nickname: userToEdit.name, // nickname이 없으므로 name으로 대체
  });
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      // TODO: 실제로는 updateUser API를 사용해야 함
  ...
  return (
    <div className="flex items-center justify-center p-5">
      ...
      >
        <h1 className="text-3xl font-semibold text-center mb-12">계정 수정</h1>
        ...
        <div className="flex justify-center gap-7 mt-12">
          ...
          >
            {createUserMutation.isPending ? "수정 중..." : "수정"}
          </button>

          <button
            onClick={() => setIsOpenEditUser(false)}
