...
export default function ErrorModal({ open, message, onClose, onFindPassword, primary }: { open: boolean; message: string | any; onClose: () => void; onFindPassword?: () => void; primary?: boolean }) {
  if (!open) return null;
