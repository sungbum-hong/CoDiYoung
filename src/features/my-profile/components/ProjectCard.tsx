...
export default function ProjectCard({ project, index: _index, isSelected: _isSelected, onSelect }: { project:  any; index?: number; isSelected?: boolean; onSelect?: (id: any) => void }) {
  const handleSelect = () => {
    if (onSelect) {
      onSelect(project?.id);
    }
