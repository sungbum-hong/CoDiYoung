...
export default function ProfileSidebar({ activeSection, onSectionChange }: { activeSection: string; onSectionChange: (section: string) => void }) {
...
export function GridLayoutSidebar({ activeSection, onSectionChange }: { activeSection: string; onSectionChange: (section: string) => void }) {
  // React Query를 사용한 프로필 데이터
  const { data: profileData } = useProfile();
...
export function MinimalFixSidebar({ activeSection, onSectionChange }: { activeSection: string; onSectionChange: (section: string) => void }) {
  // React Query를 사용한 프로필 데이터
  const { data: profileData } = useProfile();
