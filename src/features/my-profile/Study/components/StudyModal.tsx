...
import useStudyUIStore from '../../../study/model/studyUIStore';
// 새로운 훅 import - TODO: implement these modules
// import { useStudyDetail } from '../../../../hooks/useStudyQueries';
// import { mapImagesToContent } from '../../../../utils/imageUtils';

export default function StudyModal({ onEdit }: { onEdit: () => void }) {
  const {
    modals,
    selectedIndex,
    selectedStudyId,
    ...
    modals: { study: boolean };
    selectedIndex: number | null;
    selectedStudyId: any;
    closeModal: (type: string) => void;
    getFirstImage: (content: string) => string | null;
    getIntroduction: (content: string) => string;
  };

  const isOpen = modals.study;

  // TODO: implement useStudyDetail hook
  const selectedStudy: any = null;
  const isStudyLoading: boolean = false;
  const studyError: any = null;
  ...
  //   enabled: isOpen && !!selectedStudyId
  // });
  ...
  return (
    <BaseModal
      isOpen={isOpen}
      onClose={handleClose}
      // size="CUSTOM"  // Invalid prop - removed
      style={{
            ...
            <div className="h-full flex items-center justify-center">
              ...
              {selectedStudy.firstImage ? (
                <img 
                  ...
                  onError={(e) => {
                    ...
                    const fallbackDiv = (e.target as HTMLImageElement).nextSibling;
                    if (fallbackDiv) {
              ...
              <div 
                ...
                dangerouslySetInnerHTML={{
                  __html: (selectedStudy as any)?.content || '내용이 없습니다.'
                  // TODO: implement mapImagesToContent
        ...
        <div className="absolute bottom-14 left-1/2 -translate-x-1/2 flex gap-24">
          ...
          <Button
            ...
            style={{
              ...
              color: (!selectedStudyId || isStudyLoading) ? COLORS.GRAY_400 : COLORS.PRIMARY,
              borderColor: (!selectedStudyId || isStudyLoading) ? COLORS.GRAY_400 : COLORS.PRIMARY,
