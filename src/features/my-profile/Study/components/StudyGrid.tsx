...
import { getFirstImageUrl } from '../../../../shared/utils/imageUtils';
...
export default function StudyGrid({ 
  ...
  const { getFirstChar, getFirstImage } = useStudyUIStore() as { getFirstChar: (content: string) => string; getFirstImage: (content: string) => string | null };
