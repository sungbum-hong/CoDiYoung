...
import { MOCK_MY_PROJECTS } from "../../../mock/profile";
      ...
      <div className="space-y-16">
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {MOCK_MY_PROJECTS.interested?.map((project: any) => (
        ...
        <section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {MOCK_MY_PROJECTS.applied?.map((project: any) => (
        ...
        <section>
          ...
          {MOCK_MY_PROJECTS.ongoing.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {MOCK_MY_PROJECTS.ongoing?.map((project: any) => (
        ...
        <section>
          ...
          {MOCK_MY_PROJECTS.completed.length > 0 ? (
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                 {MOCK_MY_PROJECTS.completed?.map((project: any) => (
