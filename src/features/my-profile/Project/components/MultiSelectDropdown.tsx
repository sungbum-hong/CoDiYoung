...
export default function MultiSelectDropdown({ options, value = [], onChange, placeholder, className = "" }: { options: any[]; value?: any[]; onChange: (value: any[]) => void; placeholder?: string; className?: string }) {
