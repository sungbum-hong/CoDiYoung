...
export default function ProjectDatePickerModal({ isOpen, onClose, selectedDate, onDateChange }: { isOpen: boolean; onClose: () => void; selectedDate: Date | null; onDateChange: (date: Date | null) => void }) {
  const [tempDate, setTempDate] = useState<Date | null>(selectedDate || new Date());
  const [viewDate, setViewDate] = useState<Date | null>(selectedDate || new Date());
      ...
      <div className="p-2 flex flex-col items-center gap-4">
        ...
        <div className="datepicker-wrapper">
          <DatePicker
            ...
            dayClassName={(date) => {
              if (!viewDate) return 'regular-day';
              const sameMonth =
