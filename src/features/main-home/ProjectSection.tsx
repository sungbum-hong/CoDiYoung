...
// import { useBackgroundHover } from '../../hooks/useHoverStyle'; // File not found
import { useMainHomeProjects } from './hooks/useMainHomeQueries';
...
export default function ProjectSection({
  ...
  // const moreButtonHover = useBackgroundHover('transparent', COLORS.GRAY_100); // Hook not available
    ...
    <section className="relative mb-21">
      <div className="flex items-center justify-between mb-7">
        ...
        <button
          ...
          className="p-2 rounded-full transition-colors"
          style={{ backgroundColor: "transparent" }}
          // {...moreButtonHover} // Hover hook not available
          aria-label="전체 프로젝트 보기"
        >
      ...
      <ProjectDetailModal
        ...
        project={projects.find(p => p?.id === selectedProjectId) || undefined}
      />
    </section>
  );
}
