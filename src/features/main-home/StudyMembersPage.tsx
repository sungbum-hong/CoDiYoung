...
import { MOCK_GROUPED_STUDIES } from '../../mock/studyMembers';
...
export default function StudyMembersPage() {
  ...
  const dataMap: { [key: string]: 'coding' | 'design' | 'video' } = {
    coding: 'coding',
    design: 'design',
    video: 'video',
  };
    ...
    <div className="max-w-7xl mx-auto px-6 py-12 mb-24 min-h-screen">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {users.map((user: any, i: number) => {
          const avatarSrc = user.userImage || getAvatar(categoryLabel || "default", i);
